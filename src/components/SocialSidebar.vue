<template>
  <div class="social-sidebar" :class="{ hidden: !visible }">
    <a href="https://www.tiktok.com/@afmeuae" target="_blank" rel="noopener" aria-label="TikTok" class="social-link social-link--tt">
    ...
    <a href="https://www.linkedin.com/company/afmeuae/" target="_blank" rel="noopener" aria-label="LinkedIn" class="social-link social-link--li">
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
